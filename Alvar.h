...
/*
 * Moved version information to AlvarVersion.h and encapsulated into the
 * class AlvarVersion.
 *
 * TTC (12/31/15)
*/
 ...
 * \file Alvar.h
 *
 * \brief This file defines library export definitions.
 */
...
// Always do a static build.  May refine this later.  TTC!!!
#define ALVAR_EXPORT
