...
class ALVAR_EXPORT Bitset
   ...
   public:
      Bitset() = default;
      Bitset(const Bitset& src) = delete;

      ~Bitset() = default;

      Bitset& operator=(const Bitset& rhs) = delete;
    ...
    */
      ...
      const std::deque<bool>& GetBits() const
         {
         return (bits);
         }
...
class ALVAR_EXPORT BitsetExt : public Bitset
   ...
   public:
      ...
      /** \brief Constructor */
      explicit BitsetExt(bool _verbose)
         {
         SetVerbose(_verbose);
         return;
         }

      BitsetExt(const BitsetExt& src) = delete;

      ~BitsetExt() = default;

      BitsetExt& operator=(const BitsetExt& rhs) = delete;
